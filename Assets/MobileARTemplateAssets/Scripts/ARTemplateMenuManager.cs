...
public class ARTemplateMenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (m_DebugMenu != null && m_DebugMenu.gameObject != null)
        {
        ...
        if (m_PlaneManager != null && m_DebugPlane != null)
    ...
    void Update()
    {
        if (m_InitializingDebugMenu && m_DebugMenu != null && m_DebugMenu.gameObject != null)
        {
        ...
        if (m_ShowObjectMenu || m_ShowOptionsModal)
        {
            ...
            if (m_ShowObjectMenu && m_DeleteButton != null)
            {
    ...
    void ShowMenu()
    {
        if (m_ObjectMenu == null || m_ObjectMenuAnimator == null)
            return;
    ...
    {
        if (m_DebugMenu == null || m_DebugMenuSlider == null)
            return;
    ...
    void AdjustARDebugMenuPosition()
    {
        ...
        if (screenWidthInInches < 5)
        {
            ...
            if (m_DebugMenu.toolbar != null && m_DebugMenu.toolbar.TryGetComponent<RectTransform>(out var rect))
            {
            ...
            if (m_DebugMenu.displayInfoMenuButton != null && m_DebugMenu.displayInfoMenuButton.TryGetComponent<RectTransform>(out var infoMenuButtonRect))
            ...
            if (m_DebugMenu.displayConfigurationsMenuButton != null && m_DebugMenu.displayConfigurationsMenuButton.TryGetComponent<RectTransform>(out var configurationsMenuButtonRect))
            ...
            if (m_DebugMenu.displayCameraConfigurationsMenuButton != null && m_DebugMenu.displayCameraConfigurationsMenuButton.TryGetComponent<RectTransform>(out var cameraConfigurationsMenuButtonRect))
            ...
            if (m_DebugMenu.displayDebugOptionsMenuButton != null && m_DebugMenu.displayDebugOptionsMenuButton.TryGetComponent<RectTransform>(out var debugOptionsMenuButtonRect))
            ...
            if (m_DebugMenu.infoMenu != null && m_DebugMenu.infoMenu.TryGetComponent<RectTransform>(out var infoMenuRect))
            {
            ...
            if (m_DebugMenu.configurationMenu != null && m_DebugMenu.configurationMenu.TryGetComponent<RectTransform>(out var configurationsMenuRect))
            {
            ...
            if (m_DebugMenu.cameraConfigurationMenu != null && m_DebugMenu.cameraConfigurationMenu.TryGetComponent<RectTransform>(out var cameraConfigurationsMenuRect))
            {
            ...
            if (m_DebugMenu.debugOptionsMenu != null && m_DebugMenu.debugOptionsMenu.TryGetComponent<RectTransform>(out var debugOptionsMenuRect))
            {
    ...
    void OnPlaneChanged(ARTrackablesChangedEventArgs<ARPlane> eventArgs)
    {
        if (eventArgs.added.Count > 0)
        {
            foreach (var plane in eventArgs.added)
            {
                if (plane != null && plane.TryGetComponent<ARFeatheredPlaneMeshVisualizerCompanion>(out var visualizer))
                {
                    ...
                    visualizer.visualizeSurfaces = (m_DebugPlaneSlider != null && m_DebugPlaneSlider.value != 0);
                }
            }
        }
        ...
        if (m_PlaneManager != null && m_PlaneManager.trackables.count != featheredPlaneMeshVisualizerCompanions.Count)
        {
            featheredPlaneMeshVisualizerCompanions.Clear();
            foreach (var trackable in m_PlaneManager.trackables)
            {
                if (trackable != null && trackable.TryGetComponent<ARFeatheredPlaneMeshVisualizerCompanion>(out var visualizer))
                {
                    featheredPlaneMeshVisualizerCompanions.Add(visualizer);
                    visualizer.visualizeSurfaces = (m_DebugPlaneSlider != null && m_DebugPlaneSlider.value != 0);
                }
